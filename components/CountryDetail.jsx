...
export default function CountryDetail() {
  ...
  function updateCountryData(data) {
    ...
    Promise.all(
      ...
      setTimeout(() => setCountryData((prevData) => ({ ...prevData, borders })))
    });
  }
  ...
  return countryData === null ? (
    ...
    <main className={`main-container ${isDark ? "dark" : ""}`}>
      <div className="country-details-container">
        ...
        <p className="back-button" onClick={() => history.back()}>
        ...
        <p className="back-button" onClick={() => history.forward()}>
          <i className="fa-solid fa-arrow-right"></i>&nbsp; Forward to history
        </p>
        </div>
